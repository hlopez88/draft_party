...
/*	var runningBacks = ["RB1", "RB2", "RB3", "RB4", "RB5", "RB6", "RB7", "RB8", "RB9", "RB10", "RB11", "RB12"];
#    var quarterBacks = ["QB1", "QB2", "QB3", "QB4", "QB5", "QB6", "QB7", "QB8", "QB9", "QB10", "QB11", "QB12"];
#    var wideRecievers = ["WR1", "WR2", "WR3","WR4","WR5", "WR6", "WR7","WR8","WR9", "WR10", "WR11","WR12"];
#    var tightEnds = ["TE1", "TE2", "TE3","TE4","TE5", "TE6", "TE7","TE8","TE9", "TE10", "TE11","TE12"];
#    var defenses = ["DE1", "DE2", "DE3","DE4","DE5", "DE6", "DE7","DE8","DE9", "DE10", "DE11","DE12"];
#    var kickers = ["K1", "K2", "K3","K4","K5", "K6", "K7","K8","K9", "K10", "K11","K12"];
*/
    ...
    {
        $.get("testdata.txt",function(data,status)
        {
