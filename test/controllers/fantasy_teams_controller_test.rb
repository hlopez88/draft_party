...
class FantasyTeamsControllerTest < ActionController::TestCase
  ...
  test "should create fantasy_team" do
    assert_difference('FantasyTeam.count') do
      post :create, fantasy_team: { draft_position: @fantasy_team.draft_position, team_name: @fantasy_team.team_name }
    end
  ...
  test "should show fantasy_team" do
    get :show, id: @fantasy_team
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @fantasy_team
    assert_response :success
  end

  test "should update fantasy_team" do
    patch :update, id: @fantasy_team, fantasy_team: { draft_position: @fantasy_team.draft_position, team_name: @fantasy_team.team_name }
    assert_redirected_to fantasy_team_path(assigns(:fantasy_team))
  end
